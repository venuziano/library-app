...
describe('CategoryService', () => {
  ...
  describe('findById', () => {
    it('should call checker.ensureExists and return the category', async () => {
  ...
  describe('update', () => {
    ...
    it('should update and return the mutated category', async () => {
      ...
      repo.create.mockImplementationOnce((category) => Promise.resolve(category));
      repo.update.mockImplementationOnce((category) => Promise.resolve(category));
  ...
  describe('delete', () => {
    ...
    it('should delete and return entity', async () => {
      ...
      repo.delete.mockImplementationOnce((c) => Promise.resolve(c));
